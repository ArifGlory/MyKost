...
import iqbal.mykost.Kelas.PemilikKos;
import iqbal.mykost.Kelas.Utils;
...
public class DaftarPemilikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_pemilik);

        Firebase.setAndroidContext(this);
        FirebaseApp.initializeApp(DaftarPemilikActivity.this);
        ...
        fAuth.createUserWithEmailAndPassword(email,passwordUser).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()){
                    ...
                    Toast.makeText(DaftarPemilikActivity.this,"Proses Pendaftaran gagal"+task.getException().toString(),Toast.LENGTH_LONG).show();
                    ...
                    pemilikKos = new PemilikKos(userID,
                    ...
                    ref = ref.child("pemilik");
                    ref.child(userID).setValue(pemilikKos);

                    Toast.makeText(DaftarPemilikActivity.this,"Registrasi berhasil, silakan ke Halaman Login \n",Toast.LENGTH_LONG).show();

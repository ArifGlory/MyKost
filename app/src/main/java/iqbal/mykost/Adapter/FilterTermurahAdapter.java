 ...
 */
public class FilterTermurahAdapter extends RecyclerView.Adapter<FilterTermurahAdapter.MyViewHolder> {
    ...
    public FilterTermurahAdapter(final Context mContext) {
        ...
        ref.child("kosan").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    hargaKosan = Integer.parseInt(harga);
                    if (hargaKosan > temp){
                        kosanList.add(kosan);
                        list_key.add(key);
                        temp = hargaKosan;

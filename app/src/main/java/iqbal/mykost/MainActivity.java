...
public class MainActivity extends AppCompatActivity {
    ...
    Button loginButton;
    TextView forgotPassword, signUp,keHome;
    Intent i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keHome = (TextView) findViewById(R.id.keHome);
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i = new Intent(getApplicationContext(),DaftarPemilikActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Apakan anda ingin keluar dari MyKost ?");
